...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		bindPreferenceSummaryToValue(findPreference("dbmode"));
		bindPreferenceSummaryToValue(findPreference("news_entries"));
		bindPreferenceSummaryToValue(findPreference("startup_activity"));
	}
	...
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			 ...
			 * using RingtoneManager. if (TextUtils.isEmpty(stringValue)) { //
			 ...
			 * 
			 * if (ringtone == null) { // Clear the summary if there was a
			 * lookup error. preference.setSummary(null); } else { // Set the
			 * summary to reflect the new ringtone display // name. String name
